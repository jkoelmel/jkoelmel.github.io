...
const Messaging = (props) => {
    ...
    return (
        <div>
            <Widget
                title={props.pt.selectedPatient.patient_id ? "Messages From" : "Message Center"}
                subtitle={props.pt.selectedPatient.patient_id ? `${props.pt.selectedPatient.f_name} ${props.pt.selectedPatient.l_name}` : "Choose a patient"}
                showTimeStamp={false}
