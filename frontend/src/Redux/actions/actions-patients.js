...
export const createNewPatient = (patient) => {
    const data = {email: patient.email, f_name: patient.f_name, l_name: patient.l_name, company: patient.compact}
    return (dispatch) => {
...
export const updatePatientPT = (patient, pt, prospective_pt) => {
    ...
    return (dispatch) => {
        putAuth('api/patient/update-pt', data)
            ...
            .catch(err => console.log(`Error updating patient PT's to ${pt} and/or ${prospective_pt}:`, err))
    }
}
