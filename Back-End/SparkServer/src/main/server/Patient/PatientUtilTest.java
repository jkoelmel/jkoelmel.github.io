...
public class PatientUtilTest {
    ...
    void selectAllTest() {
        ...
        Assertions.assertEquals("{\"patient_id\":1,\"pt\":100,\"prospective_pt\":300,\"user_id\":111,\"email\"" +
                ":\"test@gmail.com\",\"password\":\"test\",\"f_name\":\"John\",\"l_name\":\"Doe\",\"company\":\"SFSU\"," +
                "\"secret\":\"passwordEncryption\"}", toReturn);
        Assertions.assertEquals(200, response.getStatus());
    }
    ...
    void registerPatientTest(){
        ...
        Assertions.assertEquals("{\"patient_id\":100,\"password\":\"test\",\"f_name\":\"John\",\"l_name\":\"Doe\",\"company\":\"SFSU\",\"secret\":\"passwordEncryption\"}", toReturn);
        Assertions.assertEquals(200, response.getStatus());
    }
