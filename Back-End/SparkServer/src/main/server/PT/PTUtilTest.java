...
public class PTUtilTest {
	...
	void testSelectPatients() throws IOException {
		...
		assertEquals("{\"patient_id\":1,\"user\":0,\"pt\":1,\"prospective_pt\":1,\"injury\":\"knee\",\"user_id\":0,\"email\":\"test2@mail.com\",\"password\":\"test\",\"f_name\":\"John\",\"l_name\":\"Doe\",\"company\":\"test\",\"secret\":\"passwordEncryption\"}", toReturn);
		assertEquals(200, response.getStatus());
	}
	...
	void testSelectAll() {
		...
		assertEquals("{\"pt_id\":1,\"email\":\"another@mail.com\",\"f_name\":\"Jane\",\"l_name\":\"Day\",\"company\":\"Another Test\",\"secret\":\"passwordEncryption\"}", toReturn);
	}
	...
	void testRegisterPT() {
		...
		assertEquals("{\"pt_id\":1,\"email\":\"test@mail.com\",\"password\":\"AmghBmX9T6vVzpvYoDf0dA\\u003d\\u003d\",\"f_name\":\"John\",\"l_name\":\"Doe\",\"company\":\"Test Inc\",\"secret\":\"passwordEncryption\"}", toReturn);
		assertEquals(200, response.getStatus());
	}
}
