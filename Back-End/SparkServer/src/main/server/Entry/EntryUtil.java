...
/**
 * EntryUtil class: Provides functions for usage in endpoints so that the
 * actual functionality of the CRUD operations in Entry class are encapsulated
 * properly
 */
public class EntryUtil {

  /**
   * selectSpecific: Uses the entry_id value from the queryMap provided by the
  ...
  /**
   * selectAll: Uses the patient_id value from the queryMap provided by the
   * browser request to search the database
   * @param request
   * @param response
   * @return 10 most recent entries generated by desired patient, in descending
   * order by timestamp
   */
  ...
  /**
   * registerEntry: Uses the entry String and patient_id value from the queryMap
   * provided by the browser request to place a new entry into the database
   * @param request
