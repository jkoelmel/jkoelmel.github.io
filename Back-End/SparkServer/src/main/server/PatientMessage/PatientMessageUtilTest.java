...
public class PatientMessageUtilTest {
    ...
    void selectSpecificTest() {
        ...
        PatientMessage patientMessage = new PatientMessage(Integer.parseInt(request.getParameter("message_id")));
    ...
    void selectAllTest(){
        ...
        Assertions.assertEquals("{\"message_id\":1,\"message\":\"test\",\"created_On\":" + timeFormatted +
                ",\"patient\":1,\"pt\":2,\"secret\":\"messageEncryption\"}", toReturn);
        Assertions.assertEquals(200, response.getStatus());
    }
}
