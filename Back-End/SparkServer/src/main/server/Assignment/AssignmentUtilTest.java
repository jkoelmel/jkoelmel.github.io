...
class AssignmentUtilTest {
    ...
    /**
     * Requires the patient for retrieval of patient assignments
     * Ensuring this is passed from the HTTP query params to the
     * object is essential to proper operation
     */
    @Test
    ...
    /**
     * Requires a patient and start and end timestamps to be passed
     * into an Assignment object. This method ensures retrieval of
    ...
    /**
     * Requires the pt value from the HTTP request query to
     * retrieve all of the workouts created by a particular PT.
     * This is the only facet currently tested
     */
    @Test
    ...
    /**
     * Requires a patient to be passed in from the HTTP request
     * params to find current assignment for patient.
     */
    @Test
    ...
    /**
     * Method being tested iterates over arrays of workouts and
     * patients to assign all desired workouts to requested patients.
     */
    @Test
