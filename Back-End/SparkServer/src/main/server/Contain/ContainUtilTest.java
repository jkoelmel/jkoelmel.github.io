 ...
 * generated by junit and Mockito
 */
class ContainUtilTest {
    ...
    /**
     * Requires the workout_id from the HTTP request params to be
     * tested during initial workout constructor call
     */
    @Test
    void testSelectExercises() {
        ...
        Workout workout = new Workout(Integer.parseInt
                (request.getParameter("workout_id")));
    ...
    /**
     * Requires a title, pt, and array of exercises to be passed in from
     * HTTP request pararms to create a new workout. Param passing being
     * the focal point of this test method
     */
    @Test
    void testCreateWorkout() {
        ...
        when(request.getParameterValues("exercise_id"))
