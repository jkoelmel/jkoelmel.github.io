...
class ExerciseUtilTest {
    ...
    /**
     * Requires the exercise_id from the HTTP request params to retrieve
     * selected exercise from the database. As long as constructor properly
     * assigns this value, the rest of the function shall work as desired
     */
    @Test
    ...
    /**
     * Requires no information from the HTTP request params.
     * Test checks formatting of JSON objects returned to the
    ...
    void testSelectAll() {
        ...
        assertEquals("{\"exercise_id\":1,\"exercise_url\":\"video.com/test\"," +
    ...
    /**
     * Requires the workout value from the HTTP request params.
     * Ingestion of the right value is the key component to testing
     */
    @Test
    ...
    /**
     * Requires all fields of exercise to create a new Object and add it
     * to the database. Testing involves adding all request params to the object
     * successfully
     */
    @Test
    void testRegisterExercise() {
        ...
        assertEquals("{\"exercise_id\":1,\"exercise_url\":\"video.com/test\"," +
                "\"title\":\"title\",\"description\":\"description\",\"tags\":\"tags\"}", toReturn);
        assertEquals(200, response.getStatus());
