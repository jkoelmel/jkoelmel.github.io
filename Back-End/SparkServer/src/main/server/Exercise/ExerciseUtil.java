...
public class ExerciseUtil {
    ...
    public static String getWorkoutExercises(Request request, Response response) {
        String toReturn = "";
        String query = "SELECT workout.workout_id, workout.title, exercise.title AS \"exercise\", exercise.exercise_url, exercise.description " +
                " FROM contain JOIN workout ON contain.workout = workout.workout_id " +
                "JOIN exercise ON contain.exercise = exercise.exercise_id WHERE workout_id = " + Integer.parseInt(request.queryMap().get("workout").value()) +
