...
class ActivityUtilTest {
    ...
    /**
     * Ensuring ingestion of request parameters is properly passed into Activity
     * object. Database retrieval not needed as it is dynamic and only relies on
     * these two parameters to handle query creation.
     */
    @Test
    ...
    /**
     * No parameters from query string required in this method
     * As such, the proper response is reliant on the output of a JSON object
     * that has been stringified via Gson.
     */
    @Test
    void testSelectAll() {
        ...
        assertEquals("{\"activity_id\":100,\"type_activity\":\"test\",\"start_time\":" +
                timeFormatted + ",\"end_time\":" + timeFormatted + ",\"pt\":100,\"patient\":1}",
                toReturn);

    }

    /**
     * This method only requires that the pt value is passed successfully
     * from the HTTP request query params. As such, this is the extent of
     * mocked data.
     */
    @Test
    ...
    /**
     * Method requires the HTTP query string to contain patient and pt
     * information. This is mocked and ensured to be working via the setters
     * and getters of the base Activity class
     */
    @Test
    ...
    /**
     * Requires type_activity, duration, pt, and patient from HTTP query
     * parameters to create a new activity. This test ensures JSON object created
     * is representative of what will be required by the front end upon retrieval
     * of the same object
     */
    @Test
